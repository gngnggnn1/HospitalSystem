...
<article class="page-container">
	<form action="handOutMedServlet" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-2 col-sm-2">
				...
				<%
					...
					ResultSet rs = null;
					Statement st = null;
					String sql = "select regist.registID, regist.patientName from regist join prescription using (registID) where seenDoctor = 2 and gotMed = 0;";
		...
		<div class="row cl">
			<div class="formControls col-xs-2 col-sm-2">
				<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;确认发药&nbsp;&nbsp;"onclick = "succeed()">
			</div>
			<div class="formControls col-xs-2 col-sm-2">
