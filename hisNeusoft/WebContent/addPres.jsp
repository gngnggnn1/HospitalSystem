...
<article class="page-container">
	<form action="addpresServlet" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-2 col-sm-2">
				...
				<%
					...
					ResultSet rs = null;
					Statement st = null;
					String sql = "select registID, patientName from regist where seenDoctor = 1";
		...
		<label class="form-label col-xs-1 col-sm-1"><span class="c-red">*</span>处方名称：</label>
			<div class="formControls col-xs-1 col-sm-1">
				<input type="text" class="input-text" value="" placeholder="" name="presName">
			</div>
		...
		<div class="row cl">
			<div class="formControls col-xs-2 col-sm-2">
				<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;开具处方&nbsp;&nbsp;"onclick = "succeed()">
			</div>
			<div class="formControls col-xs-2 col-sm-2">
